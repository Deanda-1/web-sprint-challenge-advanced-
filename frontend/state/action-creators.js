...
export const UPDATE_QUIZ = 'UPDAT_QUIZ'
...
export const postAnswer = (initialSelectedAnswerStatea, initialSelectedAnswerStateb, quizid, answerid, answerid2) => dispatch => {
...
export function submitO () {
  return ({ type: SUBMIT_ON })
}